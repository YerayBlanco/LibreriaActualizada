...
namespace LibreriaMSQL {
    ...
    public partial class LibreriaDataSet : global::System.Data.DataSet {
        ...
        public partial class LibrosDataTable : global::System.Data.TypedTableBase<LibrosRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public LibrosRow AddLibrosRow(string Titulo, System.DateTime FechaPublicacion, string Descripcion, int NumeroPaginas, string Autor, string Leido) {
            ...
            private void InitClass() {
                ...
                this.columnLeido = new global::System.Data.DataColumn("Leido", typeof(string), null, global::System.Data.MappingType.Element);
                ...
                this.columnAutor.MaxLength = 55;
                this.columnLeido.MaxLength = 2;
            }
        ...
        public partial class LibrosRow : global::System.Data.DataRow {
            ...
            public string Leido {
                get {
                    try {
                        return ((string)(this[this.tableLibros.LeidoColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
...
namespace LibreriaMSQL.LibreriaDataSetTableAdapters {
    ...
    public partial class LibrosTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [Libros] WHERE (([ID] = @Original_ID) AND ([Titulo] = @Original_Titulo) AND ([FechaPublicacion] = @Original_FechaPublicacion) AND ((@IsNull_Descripcion = 1 AND [Descripcion] IS NULL) OR ([Descripcion] = @Original_Descripcion)) AND ([NumeroPaginas] = @Original_NumeroPaginas))";
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [Libros] ([Titulo], [FechaPublicacion], [Descripcion], [NumeroPaginas]) VALUES (@Titulo, @FechaPublicacion, @Descripcion, @NumeroPaginas);
SELECT ID, Titulo, FechaPublicacion, Descripcion, NumeroPaginas FROM Libros WHERE (ID = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [Libros] SET [Titulo] = @Titulo, [FechaPublicacion] = @FechaPublicacion, [Descripcion] = @Descripcion, [NumeroPaginas] = @NumeroPaginas WHERE (([ID] = @Original_ID) AND ([Titulo] = @Original_Titulo) AND ([FechaPublicacion] = @Original_FechaPublicacion) AND ((@IsNull_Descripcion = 1 AND [Descripcion] IS NULL) OR ([Descripcion] = @Original_Descripcion)) AND ([NumeroPaginas] = @Original_NumeroPaginas));
