    ...
    public partial class Form1 : Form
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                TituloBox.Autor = Autor.Text;
                TituloBox.Leido = Leido.Text;
        ...
        private void Filas(object sender, DataGridViewCellEventArgs e)
        {
            ...
            Autor.Text = dataGridView1.Rows[Indice].Cells[5].Value.ToString();
            Leido.Text = dataGridView1.Rows[Indice].Cells[6].Value.ToString();
